"""
Stability analysis for the HistGradientBoosting baseline.
"""
...
def plot_stability(df):
    ...
    plt.tight_layout()
    path = os.path.join(VISUALIZATION_DIR, "stability_analysis_hist_gradient_boosting.png")
...
def main():
    ...
    print("=" * 60)
    print("Stability analysis - HistGradientBoosting")
    print("=" * 60)
    ...
    csv_path = os.path.join(EXPLAIN_DIR, "stability_hist_gradient_boosting.csv")
    json_path = os.path.join(EXPLAIN_DIR, "stability_hist_gradient_boosting.json")
